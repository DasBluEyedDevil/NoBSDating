...
- You must use OAuth authentication (Apple Sign-In or Google Sign-In)
...
You agree NOT to:
- Harass, bully, stalk, intimidate, assault, defame, harm, or otherwise mistreat any user
- Post content that is hateful, threatening, sexually explicit (outside of private messages), or promotes violence
- Use the Service for any illegal or unauthorized purpose
- Impersonate any person or entity
- Spam, solicit money from, or defraud other users
- Use another user's account
- Share your account with anyone else
- Post content that violates intellectual property or privacy rights
- Use the Service if you are a convicted sex offender
- Create multiple accounts or attempt to circumvent account bans
- Use automated scripts, bots, or crawlers
- Attempt to reverse engineer or compromise the Service

##5. Content and Intellectual Property

### 5.1 Your Content
- You retain ownership of content you post (photos, bio, messages)
- By posting content, you grant us a worldwide, non-exclusive, royalty-free license to use, display, and distribute your content in connection with the Service
- You represent that you own or have rights to all content you post
...
- Matches are based on mutual interest (both users must "like" each other)
- We do not guarantee any specific number of matches
- You are responsible for your interactions with other users
- We are not responsible for the conduct of users on or off the Service

## 7. Safety and Reporting

- You can block and report users at any time
- We investigate reports but cannot guarantee specific outcomes
- False reports may result in account suspension
- We may remove content or ban users who violate these Terms

## 8. Premium Subscriptions

- Premium features require a paid subscription
- Subscriptions auto-renew unless canceled
- Refunds are handled according to the app store's policies (Apple App Store or Google Play Store)
...
- We may terminate the Service at any time with or without notice
...
- Results from use of the Service will meet your requirements
...
- Damages resulting from user interactions (online or offline)
